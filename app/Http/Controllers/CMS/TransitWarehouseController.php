...
class TransitWarehouseController extends Controller
{
    /**
     * index
     *
    ...
    {
        return Excel::download(new WarehouseExport($request, 'transit'), 'IMS-Transit-Warehouse-List.xlsx');
    }
}
