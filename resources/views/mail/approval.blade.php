                    ...
                    <div style="max-width:100%;display:block;border-collapse:collapse;margin:0 auto;border:1px solid #e7e7e7">
                        <div style="padding:20px 22px;">
                            <div style="text-align: justify;margin-top:20px;">
                                <p>
                                    Hi {{ $name }},<br>
                                    You have 1 {{ $transaction_name }} transaction awaiting your {{ $approval_type }} with ID {{ $transaction_id }}.
                                    Please open the IMS app to carry out the {{ $approval_type }} process
                                </p>
                                <br>
                                <div style="text-align: center">
                                    <a target="_blank" href="{{ config('app.url') }}{{ $url }}" style="color:#fff;background: radial-gradient(62.98% 37.5% at 50% 50%, #056CA2 0%, #0F366C 100%);background-color:#0F366C;padding:10px 15px;text-decoration: none;border-radius:5px;">
                                        Click here to open IMS
                                    </a>
                                </div>
                                <br>
                            </div>
