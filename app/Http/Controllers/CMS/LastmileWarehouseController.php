...
class LastmileWarehouseController extends Controller
{
    /**
     * index
     *
    ...
    public function create(Request $request)
    {
        ...
        $validator = Validator::make($data, [
            'code' => ['required', 'string', Rule::unique(Warehouse::class, 'code')],
    ...
    public function update(Request $request)
    {
        ...
        $validator = Validator::make($data, [
            ...
            'code' => ['required', 'string', Rule::unique(Warehouse::class, 'code')->ignore($data['id'])],
            'name' => 'required|string|max:128',
            'address' => 'nullable|string|max:255',
            'pic_name' => 'required|string|max:128',
            'pic_phone' => 'required|string|max:128',
    ...
    {
        return Excel::download(new WarehouseExport($request, 'lastmile'), 'IMS-Lastmile-Warehouse-List.xlsx');
    }
}
