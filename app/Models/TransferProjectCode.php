...
class TransferProjectCode extends BaseModel
{
    /**
     * appends
     *
     ...
     * @return void
     */
    public function from_project_code()
    {
        return $this->belongsTo(Project::class, 'from_project_code', 'id');
    }
     ...
     * @return void
     */
    public function to_project_code()
    {
        return $this->belongsTo(Project::class, 'to_project_code', 'id');
    }
    ...
    {
        return $this->hasMany(TransferProjectCodeDetail::class, 'transfer_project_code_id', 'id');
    }
    ...
    public function approvals()
    {
        return $this->hasMany(Approval::class, 'type_id', 'id')
            ->where('type', 'transfer-project-code')
